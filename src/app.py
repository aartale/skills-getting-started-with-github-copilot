...
activities = {
    ...
    "Music Band": {
        "description": "Concert band and orchestral music performance",
        "schedule": "Mondays and Thursdays, 3:45 PM - 5:15 PM",
        "max_participants": 25,
        "participants": ["grace@mergington.edu", "mason@mergington.edu", "ava@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Hands-on experiments, projects, and STEM exploration",
